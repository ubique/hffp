...
saveURI conn shortURI uri = R.runRedis conn $ R.setnx shortURI uri
...
linkShorty shorty = concat ["<a href=\"", shorty, "\">Copy and paste your URL</a>"]

shortyCreated :: Show a => a -> String -> TL.Text
shortyCreated resp shawty = TL.concat [TL.pack (show resp), " shorty is: ", TL.pack (linkShorty shawty)]

shortyAintURI :: TL.Text -> TL.Text
shortyAintURI uri = TL.concat[uri, " wasn't an URI, did you forget http://?"]
